...
public class CleaningStationGui extends GuiContainer
{
    ...
    public CleaningStationGui(InventoryPlayer playerInv, IInventory cleaningStation)
    {
        super(new CleaningStationContainer(playerInv, cleaningStation));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (CleaningStationTile.isCleaning(this.cleaningStation))
        {
