...
public class DNACombinatorGui extends GuiContainer
{
    ...
    public DNACombinatorGui(InventoryPlayer playerInv, IInventory combinator)
    {
        super(new DNACombinatorContainer(playerInv, combinator));
