...
import org.jurassicraft.server.entity.data.JCPlayerDataClient;
import org.jurassicraft.server.message.RequestFileMessage;
import org.jurassicraft.server.paleopad.App;
import org.jurassicraft.server.paleopad.FileExplorerApp;
import org.jurassicraft.server.paleopad.JCFile;

import java.util.List;
import java.util.regex.Pattern;

public class FileExplorerGuiApp extends GuiApp
{
    ...
    public FileExplorerGuiApp(App app)
    {
        super(app);
    }
    ...
    public void render(int mouseX, int mouseY, PaleoPadGui gui)
    {
        ...
        FileExplorerApp app = (FileExplorerApp) getApp();
    ...
    private void request(String path)
    {
        ...
        JurassiCraft.networkWrapper.sendToServer(new RequestFileMessage(path));
    ...
    public void init()
    {
        request(((FileExplorerApp) app).getPath());
    }
