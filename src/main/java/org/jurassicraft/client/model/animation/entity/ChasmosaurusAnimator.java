...
{
    @Override
    protected void performAnimations(DinosaurModel model, ChasmosaurusEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale)
    {
