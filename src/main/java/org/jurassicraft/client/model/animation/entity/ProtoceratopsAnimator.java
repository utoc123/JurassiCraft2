...
{
    @Override
    protected void performAnimations(DinosaurModel model, ProtoceratopsEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale)
    {
