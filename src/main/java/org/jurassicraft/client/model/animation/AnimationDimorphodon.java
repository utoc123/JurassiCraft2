...
public class AnimationDimorphodon extends DinosaurAnimator
{
    public AnimationDimorphodon()
    {
    ...
    protected void performMowzieLandAnimations(ModelDinosaur model, float f, float f1, float rotation, float rotationYaw, float rotationPitch, float partialTicks, EntityDinosaur parEntity)
    {
        ...
        MowzieModelRenderer[] neck = new MowzieModelRenderer[] { head, neck2, neck1 };
        ...
        EntityDinosaurFlyingAggressive entity = (EntityDinosaurFlyingAggressive) parEntity;
