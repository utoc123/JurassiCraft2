...
public class AnimationEdmontosaurus extends DinosaurAnimator
{
    public AnimationEdmontosaurus()
    {
        super(JCEntityRegistry.edmontosaurus);
    }
    ...
    {
        EntityEdmontosaurus entity = (EntityEdmontosaurus) parEntity;
