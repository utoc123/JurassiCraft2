...
{
    @Override
    protected void performMowzieLandAnimations(DinosaurModel model, PteranodonEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale)
    {
