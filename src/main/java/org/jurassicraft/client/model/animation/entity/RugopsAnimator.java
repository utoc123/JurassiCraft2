...
{
    @Override
    protected void performMowzieLandAnimations(DinosaurModel model, RugopsEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale)
    {
