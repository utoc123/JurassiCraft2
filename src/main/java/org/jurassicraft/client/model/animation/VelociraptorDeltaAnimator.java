...
{
    public VelociraptorDeltaAnimator()
    {
        super(EntityHandler.INSTANCE.velociraptor_delta);
    }

    @Override
    protected void performMowzieLandAnimations(DinosaurModel model, VelociraptorDeltaEntity entity, float limbSwing, float limbSwingAmount, float rotation, float rotationYaw, float rotationPitch, float partialTicks)
    {
