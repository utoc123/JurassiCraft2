...
public class LeaellynasauraAnimator extends DinosaurAnimator
{
    public LeaellynasauraAnimator()
    {
        super(EntityHandler.INSTANCE.leaellynasaura);
    }
    ...
    {
        LeaellynasauraEntity entity = (LeaellynasauraEntity) parEntity;
