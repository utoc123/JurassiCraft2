...
public class AnimationZhenyuanopterus extends DinosaurAnimator
{
    public AnimationZhenyuanopterus()
    {
        super(JCEntityRegistry.zhenyuanopterus);
    }
    ...
    {
        EntityZhenyuanopterus entity = (EntityZhenyuanopterus) parEntity;
        ...
        MowzieModelRenderer jaw = model.getCube("LowerJaw1");
