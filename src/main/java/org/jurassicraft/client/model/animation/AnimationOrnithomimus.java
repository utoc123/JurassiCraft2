...
public class AnimationOrnithomimus extends DinosaurAnimator
{
    public AnimationOrnithomimus()
    {
    ...
    protected void performMowzieLandAnimations(ModelDinosaur model, float f, float f1, float rotation, float rotationYaw, float rotationPitch, float partialTicks, EntityDinosaur parEntity)
    {
        ...
        MowzieModelRenderer rightCalf1 = model.getCube("leg1");
        MowzieModelRenderer leftCalf1 = model.getCube("leg2");

        MowzieModelRenderer rightCalf2 = model.getCube("upperfoot1");
        MowzieModelRenderer leftCalf2 = model.getCube("upperfoot2");
