...
{
    @Override
    protected void performAnimations(DinosaurModel model, VelociraptorEchoEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale)
    {
