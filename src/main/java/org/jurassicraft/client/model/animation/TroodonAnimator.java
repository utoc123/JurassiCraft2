...
{
    public TroodonAnimator()
    {
        super(EntityHandler.INSTANCE.troodon);
    }

    @Override
    protected void performMowzieLandAnimations(DinosaurModel model, TroodonEntity entity, float f, float f1, float rotation, float rotationYaw, float rotationPitch, float partialTicks)
    {
        ...
        // Idling
        model.chainWave(tailParts, 0.2F, 0.05F, 2, entity.ticksExisted, 0.25F);
        model.chainWave(bodyParts, 0.2F, -0.03F, 5, entity.ticksExisted, 0.25F);
        model.chainWave(rightArmParts, 0.2F, -0.1F, 4, entity.ticksExisted, 0.25F);
        model.chainWave(leftArmParts, 0.2F, -0.1F, 4, entity.ticksExisted, 0.25F);
