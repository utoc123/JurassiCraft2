...
public class EmbryoCalcificationMachineRenderer extends TileEntitySpecialRenderer<EmbryoCalcificationMachineBlockEntity> {
    private Minecraft mc = Minecraft.getMinecraft();
    private TabulaModel model;
    private TabulaModel modelWithEgg;
    private ResourceLocation texture;

    public EmbryoCalcificationMachineRenderer() {
        try {
