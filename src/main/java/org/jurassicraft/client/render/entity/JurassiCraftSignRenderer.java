...
public class JurassiCraftSignRenderer implements IRenderFactory<JurassiCraftSignEntity>
{
    @Override
    ...
    public static class Renderer extends Render<JurassiCraftSignEntity>
    {
        ...
        public void doRender(JurassiCraftSignEntity entity, double x, double y, double z, float yaw, float partialTicks)
        {
            ...
            JurassiCraftSignEntity.EnumSignType enumart = entity.signType;
            float f2 = 0.03125F;
        ...
        @Override
        protected ResourceLocation getEntityTexture(JurassiCraftSignEntity entity)
        {
            return texture;
        }

        private void func_77010_a(JurassiCraftSignEntity entity, int width, int height, int textureU, int textureV)
        {
            ...
            for (int x = 0; x < width / 16; ++x)
            {
                for (int y = 0; y < height / 16; ++y)
                {
                    ...
                    vertexBuffer.pos((double) bottomX, (double) f18, (double) (-f2)).tex((double) f20, (double) f21).normal(0.0F, 0.0F, -1.0F).endVertex();
                    ...
                    vertexBuffer.pos((double) bottomX, (double) f17, (double) (-f2)).tex((double) f20, (double) f22).normal(0.0F, 0.0F, -1.0F).endVertex();
                    vertexBuffer.pos((double) bottomX, (double) f17, (double) f2).tex((double) f3, (double) f5).normal(0.0F, 0.0F, 1.0F).endVertex();
                    ...
                    vertexBuffer.pos((double) bottomX, (double) f18, (double) f2).tex((double) f3, (double) f6).normal(0.0F, 0.0F, 1.0F).endVertex();
                    vertexBuffer.pos((double) bottomX, (double) f17, (double) (-f2)).tex((double) f7, (double) f9).normal(0.0F, 1.0F, 0.0F).endVertex();
                    ...
                    vertexBuffer.pos((double) bottomX, (double) f17, (double) f2).tex((double) f7, (double) f10).normal(0.0F, 1.0F, 0.0F).endVertex();
                    vertexBuffer.pos((double) bottomX, (double) f18, (double) f2).tex((double) f7, (double) f9).normal(0.0F, -1.0F, 0.0F).endVertex();
                    ...
                    vertexBuffer.pos((double) bottomX, (double) f18, (double) (-f2)).tex((double) f7, (double) f10).normal(0.0F, -1.0F, 0.0F).endVertex();
                    vertexBuffer.pos((double) bottomX, (double) f17, (double) f2).tex((double) f12, (double) f13).normal(-1.0F, 0.0F, 0.0F).endVertex();
                    vertexBuffer.pos((double) bottomX, (double) f18, (double) f2).tex((double) f12, (double) f14).normal(-1.0F, 0.0F, 0.0F).endVertex();
                    vertexBuffer.pos((double) bottomX, (double) f18, (double) (-f2)).tex((double) f11, (double) f14).normal(-1.0F, 0.0F, 0.0F).endVertex();
                    vertexBuffer.pos((double) bottomX, (double) f17, (double) (-f2)).tex((double) f11, (double) f13).normal(-1.0F, 0.0F, 0.0F).endVertex();
        ...
        private void setLightmap(JurassiCraftSignEntity sign, float p_77008_2_, float p_77008_3_)
        {
