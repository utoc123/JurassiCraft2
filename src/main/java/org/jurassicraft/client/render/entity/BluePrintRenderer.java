...
public class BluePrintRenderer implements IRenderFactory<BluePrintEntity>
{
    ...
    public static class Renderer extends Render<BluePrintEntity>
    {
         ...
         */
        @Override
        public void doRender(BluePrintEntity entity, double x, double y, double z, float p_76986_8_, float partialTicks)
        {
        ...
        private void render(BluePrintEntity entity, int width, int height, int textureU, int textureV)
        {
        ...
        private void setLightmap(BluePrintEntity entity, float p_77008_2_, float p_77008_3_)
        {
