...
public enum JCFoodNutrients
{
    ...
    static
    {
        ...
        {
            FOODLIST.put(JCFoodNutrients.values()[i].getFoodItem(), i);
        }
    }
    ...
    JCFoodNutrients(Item foodID, double foodProximates, double foodMinerals, double foodVitamins, double foodLipids)
    {
        this.food = foodID;
