...
public class SendFileMessage extends AbstractMessage<SendFileMessage>
{
    // Send
    private JCFile file;
    ...
    public SendFileMessage(JCPlayerData data, JCFile file)
    {
        this.file = file;
    ...
    public void handleClientMessage(SendFileMessage messageSendFile, EntityPlayer entityPlayer)
    {
    ...
    @Override
    public void handleServerMessage(SendFileMessage messageSendFile, EntityPlayer entityPlayer)
    {
