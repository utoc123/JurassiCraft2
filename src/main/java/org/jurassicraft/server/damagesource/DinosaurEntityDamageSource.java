...
public class DinosaurEntityDamageSource extends DamageSource
{
    ...
    public ITextComponent getDeathMessage(EntityLivingBase entity)
    {
        ...
        String s1 = s + ".item";
        return itemstack != null && itemstack.hasDisplayName() && I18n.canTranslate(s1) ? new TextComponentTranslation(s1, entity.getDisplayName(), this.entity.getDisplayName(), itemstack.getChatComponent()) : new TextComponentTranslation(s, entity.getDisplayName(), this.entity.getDisplayName());
    }
