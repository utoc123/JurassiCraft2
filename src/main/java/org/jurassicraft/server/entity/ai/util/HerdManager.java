...
public class HerdManager
{
     ...
     */
    public BlockPos getTargetLocation(DinosaurEntity dinosaur)
    {
    ...
    private class Herd
    {
        ...
        private LinkedList<DinosaurEntity> _noise = new LinkedList<DinosaurEntity>();
        private final LinkedList<DinosaurEntity> _allDinosaurs = new LinkedList<DinosaurEntity>();
    ...
    private int getClusterRadius(Cluster cluster, DinosaurEntity dinosaur)
    {
