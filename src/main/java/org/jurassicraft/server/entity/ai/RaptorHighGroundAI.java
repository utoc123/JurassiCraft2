...
public class RaptorHighGroundAI extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (vec3d == null) {
            ...
            // "+shelterX+","+shelterY+","+shelterZ+","+this.theCreature.isOnLadder());
            return true;
        }
    }
    ...
    public boolean continueExecuting() {
        ...
        if (this.theCreature.isCollidedVertically && this.theCreature.motionX == 0 && this.theCreature.motionX == 0
                && this.theCreature.motionX == 0 && this.gliding == false) {
    ...
    private Vec3d findPossibleShelter() {
        ...
        for (int i = 0; i < 20; ++i) {
            ...
            if (!this.world.isAirBlock(blockpos1)) {
                ...
                if (recur > 5)
                    return new Vec3d(((double) blockpos1.getX()) + 0.5f, (double) blockpos1.getY(),
                            ((double) blockpos1.getZ()) + 0.5f);
