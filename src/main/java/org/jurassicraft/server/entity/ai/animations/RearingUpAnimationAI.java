 ...
 */
public class RearingUpAnimationAI<T extends EntityLiving & Animatable> extends EntityAIBase {
    protected T animatable;

    public RearingUpAnimationAI(T entity) {
        super();
    ...
    public void startExecuting() {
        this.animatable.setAnimation(EntityAnimation.REARING_UP.get());
    }
