...
import org.jurassicraft.server.entity.ai.flyer.GlideEntityAI;
import org.jurassicraft.server.entity.ai.flyer.LandEntityAI;
import org.jurassicraft.server.entity.ai.flyer.TakeOffEntityAI;
...
public abstract class AggressiveFlyingDinosaurEntity extends AggressiveDinosaurEntity
{
    ...
    {
        super(world);
        this.tasks.addTask(1, new GlideEntityAI(this));
        this.tasks.addTask(1, new LandEntityAI(this));
        this.tasks.addTask(1, new TakeOffEntityAI(this));
    }
