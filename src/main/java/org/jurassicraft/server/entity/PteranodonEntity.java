...
public class PteranodonEntity extends AggressiveFlyingDinosaurEntity // implements IEntityAIFlyingCreature, ICarnivore
{
    public PteranodonEntity(World world)
    {
        ...
        hurtSounds = new String[] { "pteranodon_hurt_1" };
        idleSounds = new String[] { "pteranodon_living_1" };
        deathSounds = new String[] { "pteranodon_death_1" };
        callSounds = new String[] { "pteranodon_call_1" };
        ...
        tasks.addTask(2, new JCNonAutoAnimSoundBase(this, 34, Animations.CALLING.get(), 100, "jurassicraft:" + getCallSound(), 2.5F)); // Call              
    }
