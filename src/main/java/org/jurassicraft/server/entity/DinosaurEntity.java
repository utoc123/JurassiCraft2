...
//        getEntityAttribute(SharedMonsterAttributes.knockbackResistance).setBaseValue(interpolate(dinosaur.getBabyKnockback(), dinosaur.getAdultKnockback())); TODO
                    ...
                    if (this.isSwimming()) {
                        ...
                        if (path != null) {
                            ...
                            if (nextPoint.yCoord >= this.posY - 1.0) {
                                ...
                                if (deltaX * deltaX + deltaZ * deltaZ < 1.5) {
                                    this.getJumpHelper().setJumping();
                                }
                            }
                        }
...
//                ", metabolism=" + metabolism +
    ...
    public static class FieldGuideInfo {
        ...
        public static FieldGuideInfo serialize(ByteBuf buf, DinosaurEntity entity) {
            ...
            info.poisoned = entity.isPotionActive(Potion.getPotionFromResourceLocation("poison"));
