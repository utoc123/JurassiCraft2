...
public class MutableVec3
{
    ...
    public MutableVec3 normalize()
    {
        ...
        {
            set(this.xCoord / d0, this.yCoord / d0, this.zCoord / d0);
        }
        return this;
    }
    ...
    {
        return set(v.xCoord, v.yCoord, v.zCoord);
    }
    ...
    {
        return set(this.yCoord * vec.zCoord - this.zCoord * vec.yCoord, this.zCoord * vec.xCoord - this.xCoord * vec.zCoord, this.xCoord * vec.yCoord - this.yCoord * vec.xCoord);
    }
    ...
    {
        return set(this.xCoord + x, this.yCoord + y, this.zCoord + z);
    }
    ...
    public MutableVec3 getIntermediateWithXValue(MutableVec3 vec, double x)
    {
        ...
        else
        {
            ...
            return d4 >= 0.0D && d4 <= 1.0D ? set(this.xCoord + d1 * d4, this.yCoord + d2 * d4, this.zCoord + d3 * d4) : null;
        }
    }
