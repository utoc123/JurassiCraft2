...
public class PaleoBaleBlock extends BlockRotatedPillar
{
    ...
    public enum Variant implements IStringSerializable
    {
        ...
        FERN(BlockHandler.SCALY_TREE_FERN, BlockHandler.SMALL_CHAIN_FERN, BlockHandler.SMALL_ROYAL_FERN, BlockHandler.SERENNA_VERIFORMANS, BlockHandler.RAPHAELIA),
        LEAVES(BlockHandler.ANCIENT_LEAVES.values().toArray(new Block[BlockHandler.ANCIENT_LEAVES.size()])),
        OTHER(BlockHandler.AJUGINUCULA_SMITHII, BlockHandler.CRY_PANSY, BlockHandler.DICKSONIA, BlockHandler.DICROIDIUM_ZUBERI, BlockHandler.WILD_ONION, BlockHandler.ZAMITES, BlockHandler.LADINIA_SIMPLEX, BlockHandler.DICTYOPHYLLUM, BlockHandler.UMALTOLEPIS, BlockHandler.LIRIODENDRITES, BlockHandler.ENCEPHALARTOS);
