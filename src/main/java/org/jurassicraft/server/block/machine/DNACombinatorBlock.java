...
public class DNACombinatorBlock extends OrientedBlock
{
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof DNACombinatorTile)
            {
                ((DNACombinatorTile) tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileentity instanceof DNACombinatorTile)
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (DNACombinatorTile) tileentity);
        }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else if (!player.isSneaking())
        {
            ...
            if (tileEntity instanceof DNACombinatorTile)
            {
                DNACombinatorTile combinator = (DNACombinatorTile) tileEntity;
