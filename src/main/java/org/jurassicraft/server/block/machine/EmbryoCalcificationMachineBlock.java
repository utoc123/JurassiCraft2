...
public class EmbryoCalcificationMachineBlock extends OrientedBlock
{
    ...
    {
        return Item.getItemFromBlock(BlockHandler.INSTANCE.embryo_calcification_machine);
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else if (!player.isSneaking())
        {
            ...
            if (tileEntity instanceof EmbryoCalcificationMachineTile)
            {
                EmbryoCalcificationMachineTile dnaSequencer = (EmbryoCalcificationMachineTile) tileEntity;
