...
public class IncubatorContainer extends Container
{
    ...
    public IncubatorContainer(InventoryPlayer playerInventory, TileEntity tileEntity)
    {
        ...
        this.addSlotToContainer(new CustomSlot(incubator, 0, 33, 28, JCItemRegistry.egg));
        this.addSlotToContainer(new CustomSlot(incubator, 1, 56, 21, JCItemRegistry.egg));
        this.addSlotToContainer(new CustomSlot(incubator, 2, 79, 14, JCItemRegistry.egg));
        this.addSlotToContainer(new CustomSlot(incubator, 3, 102, 21, JCItemRegistry.egg));
        this.addSlotToContainer(new CustomSlot(incubator, 4, 125, 28, JCItemRegistry.egg));
