...
public class DNACombinatorContainer extends Container
{
    ...
    public DNACombinatorContainer(InventoryPlayer invPlayer, IInventory combinator)
    {
        this.tileCombinator = combinator;
        this.addSlotToContainer(new StorageSlot(combinator, 0, 55, 13, true));
        this.addSlotToContainer(new StorageSlot(combinator, 1, 105, 13, true));
        this.addSlotToContainer(new StorageSlot(combinator, 2, 81, 60, true));
